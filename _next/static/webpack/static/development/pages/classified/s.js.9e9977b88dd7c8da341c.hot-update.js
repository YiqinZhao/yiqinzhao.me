...
function (_React$Component) {
  ...
  function ClassifiedArticleItem(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_10__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "onProceedButtonClick", function () {
      ...
      if (!!password && !!id) {
        var client = new clientjs__WEBPACK_IMPORTED_MODULE_22___default.a();
        var f = client.getBrowserData();
        console.log(f);
        var data = {
          id: id,
          password: password,
...
//# sourceMappingURL=s.js.9e9977b88dd7c8da341c.hot-update.js.map